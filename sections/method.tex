...
For evaluating the language modeling capability of the models we compare, we use two techniques. For evaluating the performance of the model for various downstream tasks we finetune on the XTREME benchmark \cite{hu_xtreme_nodate}. Moreover, we also use probing For evaluating the language modeling capability of the models we use s
First we finetune the language models on a crosslinugal benchmark XTREME 
