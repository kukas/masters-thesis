...
% we denote the model outputs \mathbb{R}^d
...
Note that because for one tokenizer we pretrain only one model, as it is the most costly part of the experiment, we do not have an estimate of the variance of the pretraining of the model. We will interpret the results of the experiments with this fact in mind.
