...
\usepackage{tikz}
\usetikzlibrary{positioning, shapes, arrows} %add libraries as needed (shapes, decorations, ...)
...
\include{sections/experiment_1_validity}
\include{sections/experiment_2_properties}
\include{sections/experiment_3_balancing}
